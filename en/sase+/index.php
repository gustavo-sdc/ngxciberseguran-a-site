...
<head>
    ...
    <meta property="publisher" content="NGX">
    <meta property="og:locale" content="en">
    <meta property="og:region" content="Brasil">
    <meta property="og:author" content="NGX">
    <meta property="og:site_name" content="NGX">
    <meta name="twitter:card" content="summary_large_image">   
    
    <!-- Link da página acessada -->
    <link rel="canonical" href="https://qd7.com.br/en/xsase+">
    <meta property="og:url" content="https://qd7.com.br/en/xsase+">
    
    <!-- Title -->
    <title>sase+: Endpoint Management with VPN Control and Secure Connection - QD7</title>
    <meta property="og:title" content="sase+: Endpoint Management with VPN Control and Secure Connection - QD7">
    <meta name="twitter:title" content="sase+: Endpoint Management with VPN Control and Secure Connection - QD7">
    
    <!-- Description -->
    <meta name="description" content="Experience Sase+, the complete solution for centralized endpoint management, VPN access control and secure connection technology without the need to close tunnels.">
    <meta property="og:description" content="Experience Sase+, the complete solution for centralized endpoint management, VPN access control and secure connection technology without the need to close tunnels.">
    <meta property="og:description" content="Experience Sase+, the complete solution for centralized endpoint management, VPN access control and secure connection technology without the need to close tunnels.">
    <meta name="twitter:description" content="Experience Sase+, the complete solution for centralized endpoint management, VPN access control and secure connection technology without the need to close tunnels.">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-sase+.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-sase+.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-sase+.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/logo-sase+.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/logo-sase+.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-xwan.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/logo-sase+.png">
...
<body>
    ...
    <!-- End Google Tag Manager (noscript) -->
        ...
        <!--header end-->
            ...
            <!-- Hero Start  -->
            <section class="hero-section text-white hero-ten img-background background-xsase">
                <div class="container">
                    <div class="row align-items-center main-content">
                        <div class="col-lg-6 col-md-10">
                            <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                                <img src="../assets/img/logo-sase+.png" alt="Logo-xsase+" class="img-fuid col-8 col-lg-4 mb-3">
                                <p class="lead ">
                                    Centralized management of end points, VPN access control, antivirus, connected with secure connection technology without the need to tunnel.
                                </p>
            ...
            <section class="container" >
                <div class="mb-5 p-5 justify-content-center align-items-center" id="cyber-about">
                    ...
                    <ul class="row align-items-center col-12 justify-content-center">
                        <li class="row col-12 border-bottom mb-5">
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Client for Windows + EMS MAC/LINUX/WINDOWS - with different functions.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">EMS and the complete forticlient + Forticlient EMS posture.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Complete EMS - With centralized customer management.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0  text-center">Machine inventory + Automatic update + VM on premise licenses.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0  text-center">ZTNA from FORTIOS 7 + VPN POST.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Centralized End Point Management + management in the CLOUD.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">EMS also applies posture for VPN - performing authentication and security condition checks.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">ZTNA - Relaiza identification for internal application access and connection without the need to tunnel.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">To access this application it needs to be authenticated - Including machine, antivirus, etc..</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">FORTIGATE BECOMES A PROXY + Closing the tunnel and doing splits is not necessary.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Every PUSH performed must pass through the firewall.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Sets APPLICATION CONTROL and FIREWALL POLICIES to user edge.</p>
                            </a>
                        </li>
