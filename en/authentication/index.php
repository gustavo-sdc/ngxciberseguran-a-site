...
<head>
    ...
    <link rel="canonical" href="https://qd7.com.br/en/authentication">
    <meta property="og:url" content="https://qd7.com.br/en/authentication">
    
    <!-- Title -->
    <title>Authentication: End-to-End Secure Authentication Platform - QD7</title>
    <meta property="og:title" content="Authentication: End-to-End Secure Authentication Platform - QD7">
    <meta name="twitter:title" content="Authentication: End-to-End Secure Authentication Platform - QD7">
    
    <!-- Description -->
    <meta name="description" content="Get the complete authentication platform, which offers comprehensive security at every step. Protect your data and ensure reliable authentication. Learn more now!">
    <meta property="og:description" content="Get the complete authentication platform, which offers comprehensive security at every step. Protect your data and ensure reliable authentication. Learn more now!">
    <meta property="og:description" content="Get the complete authentication platform, which offers comprehensive security at every step. Protect your data and ensure reliable authentication. Learn more now!">
    <meta name="twitter:description" content="Get the complete authentication platform, which offers comprehensive security at every step. Protect your data and ensure reliable authentication. Learn more now!">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-authentication.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-authentication.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-authentication.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/logo-authentication.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/logo-authentication.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-authentication.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/logo-authentication.png">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!--header start-->
        <header class="main-header position-absolute w-100" id="defPage" page="authentication/">
        ...
        <!-- Hero Start  -->
        <section class="hero-section text-white hero-ten background-xthentication">
            <div class="container">
                <div class="row align-items-center main-content">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <img src="../assets/img/logo-authentication.png" alt="logo-xthentication" class="img-fuid col-10 col-lg-8 mb-3">

                            <p class="lead">
                                Complete authentication platform, with end-to-end security.  
                            </p>
                            <div class="action-btn mt-5 align-items-center d-block d-sm-flex d-lg-flex d-md-flex">
                                <a href="#contact" class="btn btn-primary me-3">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Content Start -->
        <section class="container" id="#cyber-about">
            <div class="mb-5 p-5">
                <h1 class="text-center mt-xl-5 mb-5 text-primary p-xl-5">Authentication</h1>
                <ul class="row align-items-center col-12 justify-content-center">
                    <li class="row col-12 border-bottom mb-5">
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-bricks col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M0 .5A.5.5 0 0 1 .5 0h15a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H14v2h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H14v2h1.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5H.5a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 .5-.5H2v-2H.5a.5.5 0 0 1-.5-.5v-3A.5.5 0 0 1 .5 6H2V4H.5a.5.5 0 0 1-.5-.5v-3zM3 4v2h4.5V4H3zm5.5 0v2H13V4H8.5zM3 10v2h4.5v-2H3zm5.5 0v2H13v-2H8.5zM1 1v2h3.5V1H1zm4.5 0v2h5V1h-5zm6 0v2H15V1h-3.5zM1 7v2h3.5V7H1zm4.5 0v2h5V7h-5zm6 0v2H15V7h-3.5zM1 13v2h3.5v-2H1zm4.5 0v2h5v-2h-5zm6 0v2H15v-2h-3.5z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center ">Complete authentication platform + Authenticator with redundancy models (VM or Appliance).</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-hdd-stack-fill col-12 mb-3" viewBox="0 0 16 16">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">VPN authentication - SSL VPN (fortinet client - windows / mac / linux).</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-fingerprint col-12 mb-3" viewBox="0 0 16 16">
                            ...
                            <p class="col-12 p-0 mb-0  text-center">MFA with fortinet's own token + MFA at Windows logon.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-microsoft col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M7.462 0H0v7.19h7.462V0zM16 0H8.538v7.19H16V0zM7.462 8.211H0V16h7.462V8.211zm8.538 0H8.538V16H16V8.211z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0  text-center">Integration with MICROSOFT's AD, with automatic synchronization rules for user groups.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-map-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.598-.49L10.5.99 5.598.01a.5.5 0 0 0-.196 0l-5 1A.5.5 0 0 0 0 1.5v14a.5.5 0 0 0 .598.49l4.902-.98 4.902.98a.502.502 0 0 0 .196 0l5-1A.5.5 0 0 0 16 14.5V.5zM5 14.09V1.11l.5-.1.5.1v12.98l-.402-.08a.498.498 0 0 0-.196 0L5 14.09zm5 .8V1.91l.402.08a.5.5 0 0 0 .196 0L11 1.91v12.98l-.5.1-.5-.1z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Automatic allocation of tokens to configured AD groups.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-award-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="m8 0 1.669.864 1.858.282.842 1.68 1.337 1.32L13.4 6l.306 1.854-1.337 1.32-.842 1.68-1.858.282L8 12l-1.669-.864-1.858-.282-.842-1.68-1.337-1.32L2.6 6l-.306-1.854 1.337-1.32.842-1.68L6.331.864 8 0z"/>
                                <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1 4 11.794z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">PEAP, TTLS, TLS, digital certificate per user, 802.1x authentication, LDAP-S, LDAP, Join in AD group.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-pc-display col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M8 1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V1Zm1 13.5a.5.5 0 1 0 1 0 .5.5 0 0 0-1 0Zm2 0a.5.5 0 1 0 1 0 .5.5 0 0 0-1 0ZM9.5 1a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5ZM9 3.5a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 0-1h-5a.5.5 0 0 0-.5.5ZM1.5 2A1.5 1.5 0 0 0 0 3.5v7A1.5 1.5 0 0 0 1.5 12H6v2h-.5a.5.5 0 0 0 0 1H7v-4H1.5a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5H7V2H1.5Z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Integration with RADIUS, MIST JUNIPER + Integration with SINGLE SIGN ON + External LDAP Bases, etc.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-clockwise col-12 mb-3" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2v1z"/>
                                <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">If the user is locked in AD or has an expired password, it allows you to perform a remote password reset.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-door-open-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">User login tracking + Lock by period of activity.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-pie-chart-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M15.985 8.5H8.207l-5.5 5.5a8 8 0 0 0 13.277-5.5zM2 13.292A8 8 0 0 1 7.5.015v7.778l-5.5 5.5zM8.5.015V7.5h7.485A8.001 8.001 0 0 0 8.5.015z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Graphical administration that facilitates troubleshooting.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-align-center col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M8 1a.5.5 0 0 1 .5.5V6h-1V1.5A.5.5 0 0 1 8 1zm0 14a.5.5 0 0 1-.5-.5V10h1v4.5a.5.5 0 0 1-.5.5zM2 7a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Token concentration (centralization of MFA in the forti authenticator).</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-router-fill col-12 mb-3" viewBox="0 0 16 16">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Authentication of network equipment, centralized in the authenticator.</p>
                        </a>
                    </li>

                    <a class="btn btn-primary me-xl-3 col-12 col-md-4" href="#contact">Hire ></a>
