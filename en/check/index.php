...
<head>
    ...
    <link rel="canonical" href="https://qd7.com.br/en/wan">
    <meta property="og:url" content="https://qd7.com.br/en/wan">
    
    <!-- Title -->
    <title>Intelligent Hunting Rules for Enhanced Security - QD7</title>
    <meta property="og:title" content="Intelligent Hunting Rules for Enhanced Security - QD7">
    <meta name="twitter:title" content="Intelligent Hunting Rules for Enhanced Security - QD7">
    
    <!-- Description -->
    <meta name="description" content="Discover Check and go beyond traditional NAC. With smart checkpointing rules and access profile postures, our solution offers greater security and traceability for your company.">
    <meta property="og:description" content="Discover Check and go beyond traditional NAC. With smart checkpointing rules and access profile postures, our solution offers greater security and traceability for your company.">
    <meta property="og:description" content="Discover Check and go beyond traditional NAC. With smart checkpointing rules and access profile postures, our solution offers greater security and traceability for your company.">
    <meta name="twitter:description" content="Discover Check and go beyond traditional NAC. With smart checkpointing rules and access profile postures, our solution offers greater security and traceability for your company.">
    ...
    <!-- End Google Tag Manager (noscript) -->
       ...
       <div class="main-wrapper">
                                ...
                                <div class="dropdown-menu border-0 rounded-custom shadow py-0 bg-white width-fullhomepage-list-wrapper">
                                    ...
                                    <div class="dropdown-grid rounded-custom homepage-dropdown">
                                        ...
                                        <div class="dropdown-grid-item bg-white radius-left-side">
                                            ...
                                            <a id="akamai" href="https://lp.qd7.com.br/?page_id=1099" class="dropdown-link col-lg-12">
                                                <span class="demo-list  rounded text-white fw-bold">
                                            ...
                                            <a id="arista" href="https://lp.qd7.com.br/?page_id=1082" class="dropdown-link col-lg-12">
                                                <span class="demo-list  rounded text-white fw-bold">
                ...
                <div class="row align-items-center main-content">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <img src="../assets/img/logo-check.png" alt="Logo-xcheck" class="img-fuid col-8 col-lg-4 mb-3">
                            <p class="lead ">
        ...
        <section class="container">
            <div class="mb-5 p-5" id="cyber-abou">
                ...
                <ul class="row align-items-center col-12 justify-content-center">
                    <li class="row col-12 border-bottom mb-5">
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center ">Fortnet NAC + FORTINET VM + DHCP / SNMP.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Integration with AD, Radius, LDAP + IoT + Profiing + Multivendor + Certificate.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Posture - create policies for profiling devices on the network.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0  text-center">Both known and unknown network ports request admission.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Device Identifier + Authentication + Wireless Network Authentication PEAP, EAP, etc.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Cost per concurrent device connected.</p>
                        </a>
                    </li>
