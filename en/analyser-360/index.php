...
<head>
    ...
    <link rel="canonical" href="https://qd7.com.br/en/analyser-360">
    <meta property="og:url" content="https://qd7.com.br/en/analyser-360">
    
    <!-- Title -->
    <title>Analyser 360: Real-time Threat Analysis and Monitoring - QD7</title>
    <meta property="og:title" content="Analyser 360: Real-time Threat Analysis and Monitoring - QD7">
    <meta name="twitter:title" content="Analyser 360: Real-time Threat Analysis and Monitoring - QD7">
    
    <!-- Description -->
    <meta name="description" content="Advanced detection and correlation of signature and LOG behavior. Protect your business from cyber threats. Learn more!">
    <meta property="og:description" content="Advanced detection and correlation of signature and LOG behavior. Protect your business from cyber threats. Learn more!">
    <meta property="og:description" content="Advanced detection and correlation of signature and LOG behavior. Protect your business from cyber threats. Learn more!">
    <meta name="twitter:description" content="Advanced detection and correlation of signature and LOG behavior. Protect your business from cyber threats. Learn more!">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-analyser.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-analyser.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-analyser.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/logo-analyser.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/logo-analyser.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-analyser.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/logo-analyser.png">
...
<body>
    ...
    <!-- End Google Tag Manager (noscript) -->
        ...
        <!--header start-->
        <header class="main-header position-absolute w-100" id="defPage" page="analyser-360/">
        ...
        <!-- Hero Start  -->
        <section class="hero-section text-white hero-ten img-background background-xnalyser">
            <div class="container">
                <div class="row align-items-center main-content">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <img src="../assets/img/logo-analyser.png" alt="logo-xnlyser" class="img-fuid col-10 col-lg-6 mb-3">
                            <p class="lead ">
        ...
        <section class="container">
            <div class="mb-5 p-5" id="cyber-about">
                <h1 class="text-center mt-5 mb-5 text-primary p-5">Analyser 360</h1>
                <ul class="row align-items-center col-12 justify-content-center">
                    <li class="row col-12 border-bottom mb-5">
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-intersect col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2zm5 10v2a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-2v5a2 2 0 0 1-2 2H5zm6-8V2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h2V6a2 2 0 0 1 2-2h5z"/>
                              </svg>
                            <p class="col-12 p-0 mb-0 text-center ">Native integration with Fortigate + Analyser + SD-WAN and IPSEC at scale in the High End.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-app col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M11 2a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V5a3 3 0 0 1 3-3h6zM5 1a4 4 0 0 0-4 4v6a4 4 0 0 0 4 4h6a4 4 0 0 0 4-4V5a4 4 0 0 0-4-4H5z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Firewalls log center with LOG correlation possibility</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-exclamation-circle-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0  text-center">Integrated with SOC - Shows events that it considers problematic based on the threat level.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-vcard-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm9 1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5ZM9 8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4A.5.5 0 0 0 9 8Zm1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5Zm-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96c.026-.163.04-.33.04-.5ZM7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0Z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0  text-center">Based on behavior and signature analysis, it shows possible devices infected with ransware.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-aspect-ratio-fill col-12 mb-3" viewBox="0 0 16 16">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">A screen for higher risk log's + the possibility of a company SOC screen.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-bug-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M4.978.855a.5.5 0 1 0-.956.29l.41 1.352A4.985 4.985 0 0 0 3 6h10a4.985 4.985 0 0 0-1.432-3.503l.41-1.352a.5.5 0 1 0-.956-.29l-.291.956A4.978 4.978 0 0 0 8 1a4.979 4.979 0 0 0-2.731.811l-.29-.956z"/>
                                <path d="M13 6v1H8.5v8.975A5 5 0 0 0 13 11h.5a.5.5 0 0 1 .5.5v.5a.5.5 0 1 0 1 0v-.5a1.5 1.5 0 0 0-1.5-1.5H13V9h1.5a.5.5 0 0 0 0-1H13V7h.5A1.5 1.5 0 0 0 15 5.5V5a.5.5 0 0 0-1 0v.5a.5.5 0 0 1-.5.5H13zm-5.5 9.975V7H3V6h-.5a.5.5 0 0 1-.5-.5V5a.5.5 0 0 0-1 0v.5A1.5 1.5 0 0 0 2.5 7H3v1H1.5a.5.5 0 0 0 0 1H3v1h-.5A1.5 1.5 0 0 0 1 11.5v.5a.5.5 0 1 0 1 0v-.5a.5.5 0 0 1 .5-.5H3a5 5 0 0 0 4.5 4.975z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Command and control - real-time detection and visualization + HA solution via VM.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-file-text-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM5 4h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1zm-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zM5 8h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1zm0 2h3a.5.5 0 0 1 0 1H5a.5.5 0 0 1 0-1z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Standard +300 custom reports with SQL database select.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-motherboard-fill col-12 mb-3" viewBox="0 0 16 16">
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">7121 Ultra High End Chassis Design - Modular Chassis.</p>
                        </a>
                    </li>
