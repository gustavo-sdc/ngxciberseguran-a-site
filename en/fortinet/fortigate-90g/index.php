...
<head>
    ...
    <!-- Title -->
    <title>Firewall Fortigate 90G: the best price is at QD7</title>
    <meta property="og:title" content="Firewall Fortigate 90G: the best price is at QD7">
    <meta name="twitter:title" content="Firewall Fortigate 90G: the best price is at QD7">
    
    <!-- Description -->
    <meta name="description" content="Looking for security and SD-WAN solutions? QD7 has Fortinet's Firewal FortiGate 90. Check it out!">
    <meta property="og:description" content="Looking for security and SD-WAN solutions? QD7 has Fortinet's Firewal FortiGate 90. Check it out!">
    <meta property="og:description" content="Looking for security and SD-WAN solutions? QD7 has Fortinet's Firewal FortiGate 90. Check it out!">
    <meta name="twitter:description" content="Looking for security and SD-WAN solutions? QD7 has Fortinet's Firewal FortiGate 90. Check it out!">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/fortigate-90g.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/fortigate-90g.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/fortigate-90g.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/fortigate-90g.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/fortigate-90g.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/fortigate-90g.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/fortigate-90g.png">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!--header start-->
        <header class="main-header position-absolute w-100" id="defPage" page="fortinet/fortigate-90g/">
                    ...
                    <div class="col-12">
                        <div class="row mt-5 mt-lg-0 mb-5 mt-xl-0 align-items-center justify-content-between">
                            <div class="text-center col-lg-6 col-12">
                                <img src="../../assets/img/fortigate/fortigate-90g.png" alt="fortigate-90g" class="img-fluid pb-3 border-bottom">
                                ...
                                <ol class="col-12 text-center row justify-content-center">
                                    <p class="d-grid col-lg-6 col-6 row align-items-center mt-3 mb-3 justify-content-center g-row-5">
                                        ...
                                        Multiple GE RJ45 + SFP Slots + Media Sharing
                                    </p>
                                    <p class="d-grid col-lg-6 col-6 row align-items-center mt-3 mb-3 justify-content-center g-row-5">
                            ...
                            <div class="col-lg-6 col-12 p-4">
                                <h1 class="text-primary fw-normal">FortiGate 90G</h1>
                                <h2 class="fw-normal fs-4 pb-3">Next generation converged firewall (NGFW) and SD-WAN</h2>
                                <p class="text-left">
                                    The FortiGate Next-Generation Firewall 90G series is
                                    ideal for creating security-oriented networks in
                                    and transform WAN architecture at any scale.
                                    scale.                                
                                </p>
        ...
        <section class="container">
            <div class="mb-2 p-lg-5 p-3 justify-content-center align-items-center">
                ...
                <p>
                    With a rich set of AI/ML-based FortiGuard security services and our integrated platform, 
                    the FortiGate 90G series offers coordinated, automated, end-to-end protection against threats in all use cases.              
                </p>               
                <p>
                    FortiGate has the industry's first integrated SD-WAN and zero-trust network access (ZTNA) in an NGFW solution.
                    in an NGFW solution and is powered by one operating system. The FortiGate 90G automatically
                    controls, verifies and facilitates user access to applications, providing consistency with a
                    user experience.
                </p>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center text-center bg-black border-radius rounded" id="sobre">
                ...
                <li class="col-12 row align-items-center justify-content-center text-center">
                    ...
                    <div class="row col-lg-4 col-12 g-row-3 mt-2 mb-2">
                        ...
                        Patented performance with FortiNet / SoC processors.                    
                    </div>
                    ...
                    <div class="row col-lg-4 col-12 g-row-3 mt-2 mb-2">
                        ...
                        Enterprise security with consolidated AI / FortiGuard services with ML technology.
                    </div>
                    ...
                    <div class="row col-lg-4 col-12 g-row-3 mt-2 mb-2">
                        ...
                        Simple operations, centralized management, security, automation, in-depth analysis and self-recovery.
                    </div>
                </li>
            ...
            <div class=" p-lg-5 p-3 justify-content-center align-items-center text-center">
                <h2 class="fw-normal pt-1">
                    Secure an advantage in <span class="fw-semibold">any scale.</span>
                </h2>
                ...
                <div class="row col-12 align-items-center justify-content-center">
                    <h3 class="mt-3 fs-3 text-primary mb-5 fw-normal">Developed with SD-WAN ASIC SP5</h3>
                    <div class="row col-12 text-center align-items-center justify-content-center gap-5-lg">
                        <div class="row col-12 border-bottom p-2 rounded-5 mb-3 shadow justify-content-center align-items-center">
                            <div clas="row">
                                <img src="../../assets/img/fortigate/SP5.png" alt="image SP5" class="img-fluid rounded-3 m-5 col-3">
                            </div>
                            <h4 class="fs-5 mb-3">FortiSP5 processor</h4>
                            <ul class="row justify-content-around">
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    RISC-based CPU + Fortinet's proprietary SPU,
                                ...
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Provides the industry's fastest application identification and guidance for efficient business.
                                ...
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Speeds up IPsec VPN performance for a better user experience when accessing the Internet directly.
                                </li>
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    It enables the best NGFW security and deep SSL inspection with high performance.
                                </li>
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Extends security to the access layer to enable SD-Branch transformation with acceleration and
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center">
                <div class="row col-12 align-items-center justify-content-center">
                    ...
                    <div class="row col-12 gap-5 align-items-center justify-content-center">  
                        ...
                        <div class="row col-lg-12 border p-lg-5 pt-5 pb-5 shadow rounded ">
                            <h4 class="text-primary fw-normal">Universal ZTNA</h4>
                            <ul class="gap-5 col-12">
                                <li class="align-items-center row g-row-6 p-3 border-bottom">
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Control access to applications, no matter where the user is or where they are.
                                ...
                                <li class="align-items-center row g-row-6 p-3 border-bottom">                                    
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Provides extensive authentication, checks and applies policies before granting the application
                                        access - always.
                                    </p>
                                </li>
                                <li class="align-items-center row g-row-6 p-3">   
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Agent-based access with FortiClient or agentless access via proxy portal for guests or BYOD
                                    </p>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center">
                <h2 class="fw-normal pt-1 w-100 text-center">
                    Hardware <span class="fw-semibold">FortiGate 90G Series</span>
                </h2>

                <div class="text-center mt-5 mb-5">
                    <img src="../../assets/img/fortigate/fortigate-90g-items.png" alt="fortgate items" class="img-fluid">
                </div>

                <ul class="row col-12 justify-content-center text-center">
                    <div class="col-6 col-lg-4 align-items-center">
                ...
                <div class="row col-12 mt-5">
                    ...
                    <p class="">
                        Designed for small environments, you can place it on a table or mount it on the wall. It's small,
                        lightweight, but highly reliable with a superior MTBF (mean time between failures), minimizing
                        the chance of a network interruption.
                    </p>
                </div>
                <div class="row col-12 mt-3">
                    ...
                    <p class="">
                        The FortiGate 90G series features a dedicated module that strengthens physical network devices by
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center">
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>10/5/2.5/GE RJ45 or 10GE/GE SFP+/
                                Shared SFP media pairs</td>
                            <td>2</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Firewall throughput
                                (UDP packets of 1518 / 512 / 64 bytes)
                            </td>
                            <td>28 / 28 / 27.9 Gbps</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>IPsec VPN transfer rate (512 bytes) <sup>1</sup></td>
                            <td>25 Gbps</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>IPsec VPN tunnels gateway to gateway</td>
                            <td>200</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>IPsec client-gateway VPN tunnels</td>
                            <td>2500</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Simultaneous SSL-VPN users (Maximum recommended, tunnel mode)</td>
                            <td>200</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Simultaneous SSL Inspection Session (IPS, HTTPS media) <sup>3</sup></td>
                            <td>300 000</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Application control transfer rate (HTTP 64K) <sup>3</sup></td>
                            <td>6.7 Gbps</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 p-3 border-bottom pb-2">
                            ...
                            <td>1.65 x 8.5 x 7.0</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Height x Width x Length (mm)</td>
                            <td>42 x 216 x 178 mm</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Weight</td>
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 p-3 border-bottom pb-2">
                            ...
                            <td>12V DC, 3A (double redundancy optional)</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Power supply required (Redundancy optional)</td>
                            <td>Powered by up to 2 adapters 100-240V AC,
                                50/60 Hz (1 adapter included)</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Power supply required (Redundancy optional)</td>
                            <td>Powered by up to 2 adapters 100-240V AC,
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            ...
                            <td>80Plus compliance</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Maximum current</td>
                            <td>115Vac/0.4A, 230Vac/0.2A</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Energy consumption (Average/Maximum)</td>
                            <td>19.9 W / 20.53 W</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Humidity</td>
                            <td>10% to 90% without condensation</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Noise level</td>
                            <td>21.73 dBA</td>     
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            ...
                            <td>Up to 10,000 feet (3048 m)</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Compliance</td>
