...
<head>
    ...
    <!-- Title -->
    <title>FortiGate 1800F | Best Price - QD7</title>
    <meta property="og:title" content="FortiGate 1800F | Best Price - QD7">
    <meta name="twitter:title" content="FortiGate 1800F | Best Price - QD7">
    
    <!-- Description -->
    <meta name="description" content="As one of the latest devices in the FortiGate range, the 1800F represents the continued evolution of Fortinet's security and SD-WAN solutions, check it out!">
    <meta property="og:description" content="As one of the latest devices in the FortiGate range, the 1800F represents the continued evolution of Fortinet's security and SD-WAN solutions, check it out!">
    <meta property="og:description" content="As one of the latest devices in the FortiGate range, the 1800F represents the continued evolution of Fortinet's security and SD-WAN solutions, check it out!">
    <meta name="twitter:description" content="As one of the latest devices in the FortiGate range, the 1800F represents the continued evolution of Fortinet's security and SD-WAN solutions, check it out!">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/fortigate-1800f.png">
                    ...
                    <div class="col-12">
                        <div class="row mt-5 mt-lg-0 mt-xl-0 align-items-center justify-content-between">
                            <div class="text-center col-lg-6 col-12">
                                ...
                                <ol class="col-12 text-center row justify-content-center">
                                    <p class="d-grid col-lg-6 col-10 row align-items-center mt-3 mb-3 justify-content-center g-row-5">
                                        ...
                                        Multiples GE RJ45/ SFP28/ SFP+/ SFP/ QSFP+ Slots
                                    </p>
                                    <p class="d-grid col-lg-6 col-10 row align-items-center mt-3 mb-3 justify-content-center g-row-5">
                            ...
                            <div class="col-lg-6 col-12 p-4">
                                ...
                                <p class="text-left">
                                    The FortiGate 1800F Series enables organizations to build
        ...
        <section class="container">
            <div class="mb-2 p-lg-5 p-3 justify-content-center align-items-center">
                ...
                <p>
                    ...
                    platform, the FortiGate 1800F Series delivers coordinated, automated, end-to-end threat
                    protection across all use cases.
                </p>
                <p>
                    The industry’s first integrated Zero Trust Network Access (ZTNA) enforcement within an
                    NGFW solution, FortiGate 1800F automatically controls, verifies, and facilitates user access to
                ...
                <div class="action-btn mt-3 align-items-center d-block d-sm-flex d-lg-flex d-md-flex">
                    <a href="#contact" class="btn btn-primary me-3">Compre Agora</a>
                </div>
            </div>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center">
                ...
                <div class="text-center mt-5 mb-5">
                    <img src="../../assets/img/fortigate/fortigate-1800f-items.png" alt="fortgate items" class="img-fluid">
                </div>
                ...
                <ul class="row col-12 justify-content-center text-center mb-5">
                    ...
                    <div class="col-6 col-lg-3 align-items-center">
                        ...
                        <p class="mt-3">
                            4 x 100 GE QSFP28 /40 GE QSFP+ Slots*
                        </p>
                    </div>
                </ul>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center">
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 p-3 border-bottom pb-2 ">
                            <td>Hardware Accelerated GE RJ45 Ports</td>
                            <td>16</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2 ">
                            <td>Hardware Accelerated GE SFP Slots</td>
                            <td>8</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2 ">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>10 GE SFP+ / GE SFP HA Slots</td>
                            <td>2</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>USB 3.0 Port</td>
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>IPS Throughput <sup>2</sup></td>
                            <td>22 Gbps</td>
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>NGFW Throughput<sup>2,4</sup></td>
                            <td>17 Gbps</td>     
                        </tr>
                        <tr class="col-12 p-3">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Redundant Power Supplies
                                Hot Swappable</td>
                            <td>Yes
                                (Default dual AC PSU for 1+1 Redundancy)</td>     
                        </tr>
                        <tr class="col-12 p-3">
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        ...
                        <tr class="col-12 p-3 border-bottom pb-2">
                            ...
                            <td>Side and Front to Back</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Operating Altitude</td>
                            <td>Up to 7400 ft (2250 m)</td>     
                        </tr>
                        <tr class="col-12 p-3 border-bottom pb-2">
                            <td>Compliance</td>
