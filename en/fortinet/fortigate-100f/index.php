...
<head>
    ...
    <!-- Title -->
    <title>Firewall Fortigate 100F?  A QD7 tem o melhor preço</title>
    <meta property="og:title" content="Firewall Fortigate 100F?  A QD7 tem o melhor preço">
    <meta name="twitter:title" content="Firewall Fortigate 100F?  A QD7 tem o melhor preço">
    
    <!-- Description -->
    <meta name="description" content="O Firewwal FortiGate 100F é uma das melhores soluções de segurança e SD-WAN da Fortinet.">
    <meta property="og:description" content="O Firewwal FortiGate 100F é uma das melhores soluções de segurança e SD-WAN da Fortinet.">
    <meta property="og:description" content="O Firewwal FortiGate 100F é uma das melhores soluções de segurança e SD-WAN da Fortinet.">
    <meta name="twitter:description" content="O Firewwal FortiGate 100F é uma das melhores soluções de segurança e SD-WAN da Fortinet.">
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!--header start-->
        <header class="main-header position-absolute w-100" id="defPage" page="fortinet/fortigate-100f/">
                    ...
                    <div class="col-12">
                        <div class="row mt-5 mt-lg-0 mb-5 mt-xl-0 align-items-center justify-content-between">
                            <div class="text-center col-lg-6 col-12">
                                <img src="../../assets/img/fortigate/FortiGate-100F.png" alt="fotigate200f" class="img-fluid pb-3 border-bottom">
                                ...
                                <ol class="col-12 text-center row justify-content-center">
                                    ...
                                    <p class="d-grid col-lg-6 col-10 row align-items-center mt-3 mb-3 justify-content-center g-row-5">
                                        ...
                                        Proteção de 700 Mbps 
                                    </p>
                                </ol>
                            </div>
                            <div class="col-lg-6 col-12 p-4">
                                <h1 class="text-primary pb-3 fw-normal">FortiGate 100F Possui recursos poderosos</h1>

                                <p class="text-left">
                                    O FortiGate 100F é um dispositivo de segurança de rede e SD-WAN fabricado pela Fortinet, 
                                    líder global em soluções de cibersegurança. Projetado para atender às demandas de redes de médio 
                                    porte e filiais de empresas, o FortiGate 100F oferece um conjunto abrangente de recursos de 
                                    segurança e funcionalidades avançadas de SD-WAN em um único dispositivo integrado. 
                                </p>
        ...
        <section class="container">
            <div class="mb-2 p-lg-5 p-3 justify-content-center align-items-center">
                <h2 class="fs-2 fw-normal pt-3 pb-3">
                    Security guaranteed with Fortigate 100f
                </h2>

                <p>
                    In addition, Fortigate 100F is part of the Fortinet Security Fabric security ecosystem, which allows the integration and automation between the various network security components, providing a more comprehensive and more cyber threats.
                    <br>
                    Through its intuitive management interface, Fortigate 100F allows network administrators to easily configure and monitor network safety policies and performance, ensuring smooth and secure operation.
                </p>
                
                <h2 class="fs-2 fw-normal pt-3 pb-3">
                    Get the 100f fortigate with Qd7
                </h2>
                
                <p>
                    As an authorized dealer of Fortinet, QD7 offers expertise and support specializing in the implementation of Fortinet solutions, including Fortigate 100F.With a proven history of delivery of high quality network security solutions, QD7 is the ideal choice for companies that seek to purchase Fortigate 100F and other Fortinet solutions.In addition, QD7 offers specialized technical consulting and technical support services to ensure that its customers get the maximum value of your network safety solutions. 
                </p>
                
                <span class="fw-bold">
                    QD7 is an authorized Fortinet dealer, contact us right now and request a quote from the best firewall on the market!
                </span>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center text-center bg-black border-radius rounded">
                <h2 class="fw-normal pt-1 pb-3 text-white">
                    Ia/ml security and deep visibility                
                </h2>
                ...
                <li class="col-12 row align-items-center justify-content-center text-center">
                    ...
                    <div class="row col-lg-4 col-12 g-row-3 mt-2 mb-2">
                        ...
                        Safety -oriented network, Fortios offers a convergent and secure network.                    
                    </div>
                    ...
                    <div class="row col-lg-4 col-12 g-row-3 mt-2 mb-2">
                        ...
                        Business Safety with AI / Services Fortiguard with ML technology.                    
                    </div>
                    ...
                    <div class="row col-lg-4 col-12 g-row-3 mt-2 mb-2">
                        ...
                        Deep check: applications, users, and devices + traditional firewall.                    
                    </div>
                </li>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center text-center">
                <h2 class="fw-normal pt-1">
                    Ensure an advantage in <span class="fw-semibold">any scale.</span>
                </h2>
                <h4 class="fw-light pb-3">                    
                    Developed by the Security Processing Unit (SPU)
                </h4>
                <p class="mb-5">
                    Traditional firewalls cannot protect against current content and connection -based threats
                    because they depend on hardware ready for use and cpus for general use, causing a dangerous danger
                    performance gap.Fortinet custom SPU processors offer the power you need - until
                    520 GBPS - To detect emerging threats and block malicious content, while ensuring your network
                    Safety solution does not become a performance bottleneck.
                </p>

                <div class="row col-12 align-items-center justify-content-center">
                    <h3 class="mt-3 fs-3 text-primary mb-5 fw-normal">Developed with SD-Wan Asic Soc4</h3>
                    <div class="row col-12 text-center align-items-center justify-content-center gap-5">
                        <div class="row col-12 border-bottom p-2 rounded-5 mb-3 shadow justify-content-center align-items-center">
                            <div clas="row">
                                <img src="../../assets/img/fortigate/fortisoc4.png" alt="image FortiSoc4" class="img-fluid rounded-3 m-5 col-3">
                            </div>
                            <h4 class="fs-5 mb-3">Fortisoc4 processor4</h4>
                            <ul class="row justify-content-around">
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    CPU based on RISC + SPU owner of Fortinet,
                                    Content and network processors for performance.
                                </li>
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Provides identification and guidance of faster apps in the industry for efficient business.
                                ...
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Accelerates VPN IPSEC's performance for better user experience in direct internet access.
                                </li>
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Allows the best NGFW safety and high performance deep SSL inspection.
                                </li>
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    ...
                                    Extend safety to the access layer to allow SD-BRANCH transformation with acceleration and
                                    Integrated Switch connectivity and access point.
                                </li>
                                <li class="col-lg-6 col-12 d-grid text-center row p-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="black" class="bi bi-ui-radios-grid" viewBox="0 0 16 16">
                                        <path d="M3.5 15a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5m9-9a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5m0 9a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5M16 3.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0m-9 9a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0m5.5 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m-9-11a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3m0 2a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
                                    </svg>
                                    Reduces environmental footprint saving, on average, more than 60% in energy consumption
                                    compared to the previous generation of fortigate models.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <li class="list-group">
                    <h3 class="fs-4">Centralized Network and Safety Management on Scale</h3>
                    <p class="">
                        Fortimanager, centralized management
                        Fortinet solution, allows integration
                        Fortinet security structure management,
                        including devices such as fortigate, fortiswitch,
                        and Fortiap.Simplifies and automates the
                        Supervision of Network and Security Functions
                        in various environments, serving as
                        the fundamental component for the implementation
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center" id="sobre">
                <div class="row col-12 align-items-center justify-content-center">
                    ...
                    <div class="row col-12 gap-5 align-items-center justify-content-center">  
                            ...
                            <ul class="gap-5 col-12">
                                <li class="align-items-center row g-row-6 p-3 border-bottom col-12">
                                    ...
                                    <p class="col-lg-10 col-12 text-left">
                                        The security services set fueled by Fortiguard Labs AI -
                                        natively integrated with your NGFW -
                                        Protects the web, content and devices and protects networks from sophisticated cyber ransomware and cyber attacks.
                                    </p>
                                </li>
                                <li class="align-items-center row g-row-6 p-3 border-bottom">                                    
                                    ...
                                    <p class="col-10 text-left">
                                        The real -time SSL inspection (including TLS 1.3) provides total visibility of users, devices and
                                        applications throughout the attack surface.
                                    </p>
                                </li>
                            ...
                            <ul class="gap-5 col-12">
                                <li class="align-items-center row g-row-6 p-3 border-bottom">
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Fortigate Wan Edge fueled by an operating system and unified safety and management structure
                                ...
                                <li class="align-items-center row g-row-6 p-3 border-bottom">                                    
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Offers superior quality experience and effective safety posture to work anywhere
                                        where models, sd-white and wan use cases that prioritize the cloud
                                    </p>
                                </li>
                                <li class="align-items-center row g-row-6 p-3">   
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Obtain operational efficiency on any scale through automation, deep analysis and
                                        self
                                    </p>
                                </li>
                            </ul>
                        ...
                        <div class="row col-lg-12 border p-lg-5 pt-5 pb-5 shadow rounded ">
                            <h4 class="text-primary fw-normal">ztnaUniversal</h4>
                            <ul class="gap-5 col-12">
                                <li class="align-items-center row g-row-6 p-3 border-bottom">
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                        Control access to applications, no matter where the user is and wherever they are.
                                        The application is hosted for universal application of access policies.
                                    </p>
                                </li>
                                <li class="align-items-center row g-row-6 p-3 border-bottom">                                    
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                                                                Provides extensive authentications, checks and applies policies before granting the application
                                        Access - Always.
                                    </p>
                                </li>
                                <li class="align-items-center row g-row-6 p-3">   
                                    ...
                                    <p class="col-12 col-lg-10 text-left">
                                    Forticlient agent access or agent access via proxy portal for guests or Byod                                    
                                    </p>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center" id="sobre">
                <h2 class="fw-normal pt-1 w-100 text-center">
                    Hardware <span class="fw-semibold">FortiGate 100F Series</span>
                </h2>
                ...
                <ul class="row col-12 justify-content-center text-center">
                    ...
                    <div class="col-6 col-lg-2 align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-7-circle-fill" viewBox="0 0 16 16">
                    ...
                    <div class="col-6 col-lg-2 align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-8-circle-fill" viewBox="0 0 16 16">
                    ...
                    <div class="col-6 col-lg-2 align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-9-circle-fill" viewBox="0 0 16 16">
                        ...
                        <p class="mt-3">
                            4x Pares de mídia GE RJ45/SFP compartilhados
                        </p>
                    </div>
                </ul>
            ...
            <div class="mb-5 p-lg-5 p-3 justify-content-center align-items-center" id="sobre">
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="border-bottom col-12 p-3">
                            <td>GE RJ45 Ports accelerated by hardware</td>
                            <td>12</td>
                        </tr>
                        <tr class="border-bottom col-12 p-3">
                            <td>Ge RJ45 Hardware accelerated
                                <br>
                                Management/ Doors HA/ DMZ</td>
                            <td>1 / 2 / 1</td>     
                        </tr>
                        <tr class="border-bottom col-12 p-3">
                            <td>GE SFP slots accelerated by hardware</td>
                            <td>4</td>     
                        </tr>
                        <tr class="border-bottom col-12 p-3">
                            <td>SFP+ 10 ge accelerated by hardware
                                <br>
                                Fortilink slots (standard)</td>
                            <td>2</td>     
                        </tr>
                        <tr class="border-bottom col-12 p-3">
                            <td>Questions a surant person Ralgajide 45 to</td>
                            <td>2</td>     
                        </tr>
                        <tr class="border-bottom col-12 p-3">
                            <td>Shared ports GE RJ45 or SFP *</td>
                            <td>4</td>     
                        </tr>
                        <tr class="border-bottom col-12 p-3">
                            <td>USB port</td>
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 border-bottom  p-3">
                        ...
                        <tr class="col-12 p-3">
                            <td>Threat protection transfer rate <sup>2,5</sup></td>
                            <td>1 Gbps</td>     
                        </tr>
                    </table>
                </details>
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 border-bottom p-3">
                            <td>Firewall transfer rate IPv4
                                (1518/512/64 bytes, UDP)
                            </td>
                            <td>20 / 18 / 10 Gbps</td>
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Firewall latency (64 bytes, UDP)</td>
                            <td>4.97 μs</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Firewall transfer rate (package per second)</td>
                            <td>15 Mpps</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Simultaneous Sessions (TCP)</td>
                            <td>1.5 Million</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                        ...
                        <tr class="col-12 border-bottom p-3">
                            <td>VPN Transfer Rate IPSEC (512 bytes) <sup>1</sup></td>
                            <td>11.5 Gbps</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>VPN Tunnels Ipsec Gateway for Gateway</td>
                            <td>2000</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>VPN Tunnels IPSEC Customer-Gateway</td>
                            <td>16 000</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>SSL-VPN transfer rate</td>
                            <td>1 Gbps</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>SSL-VPN users simultaneous (recommended maximum, tunnel mode)</td>
                            <td>500</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>SSL Inspection Transfer Fee (IPS, AVG. Https) <sup>3</sup></td>
                            <td>1 Gbps</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>SSL Inspection CPS (IPS, Average HTTPS) <sup>3</sup></td>
                            <td>1800</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Simultaneous SSL Inspection Session (IPS, Average HTTPS) <sup>3</sup></td>
                            <td>135 000</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Application Control Transfer Fee (HTTP 64K) <sup>3</sup></td>
                            <td>2.2 Gbps</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Capwap transfer rate (http 64k)</td>
                            <td>15 Gbps</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Virtual domains (standard/maximum)</td>
                            <td>10 / 10</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Maximum number of Support Fortiswitches</td>
                            <td>32</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Maximum number of fortiaps (total / tunnel)</td>
                            <td>128 / 64</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                        ...
                        <tr class="col-12 p-3">
                            <td>High availability settings</td>
                ...
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        <tr class="col-12 border-bottom p-3">
                            <td>Height x Width x Length (inch)</td>
                            <td>1.73 x 17 x 10</td>
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Height x Width x Length (mm)</td>
                            <td>44 x 432 x 254</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>peso</td>
                            <td>7.25 lbs (3.29 kg)</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Form factor (supports eia/non-eia standards)</td>
                            <td>Rack Mounting, 1ru</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>CA power supply</td>
                            <td>100–240V AC, 50/60 Hz</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Energy consumption (average/maximum)</td>
                            <td>26.5 W / 29.5 W</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                        ...
                        <tr class="col-12 border-bottom p-3">
                            ...
                            <td>Yes
                                (F.A double non -exchangable standard Ca for
                                Redundance 1+1)
                            </td>     
                        </tr>
                        <tr class="col-12 p-3">
                            <td>F.A</td>
                            <td>Compatible with 80plus</td>     
                        </tr>
                    </table>
                </details>
                <details class="col-12 p-3 border shadow mb-3 rounded">
                    ...
                    <table class="col-12 p-5 align-items-center justify-content-center">
                        ...
                        <tr class="col-12 border-bottom p-3">
                            ...
                            <td>Up to 10,000 feet (3,048 m)</td>     
                        </tr>
                        <tr class="col-12 border-bottom p-3">
                            <td>Conformity</td>
