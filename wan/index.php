...
<head>
    ...
    <link rel="canonical" href="https://qd7.com.br/wan">
    <meta property="og:url" content="https://qd7.com.br/wan">
    
    <!-- Title -->
    <title>WAN: Firewall, SDWAN e Segurança com Manipulação de Tráfego - QD7</title>
    <meta property="og:title" content="WAN: Firewall, SDWAN e Segurança com Manipulação de Tráfego - QD7">
    <meta name="twitter:title" content="WAN: Firewall, SDWAN e Segurança com Manipulação de Tráfego - QD7">
    
    <!-- Description -->
    <meta name="description" content="Descubra o WAN, uma solução completa que vai além do firewall e SDWAN. Tenha segurança avançada, manipulação de tráfego e priorização de aplicações críticas.">
    <meta property="og:description" content="Descubra o WAN, uma solução completa que vai além do firewall e SDWAN. Tenha segurança avançada, manipulação de tráfego e priorização de aplicações críticas.">
    <meta property="og:description" content="Descubra o WAN, uma solução completa que vai além do firewall e SDWAN. Tenha segurança avançada, manipulação de tráfego e priorização de aplicações críticas.">
    <meta name="twitter:description" content="Descubra o WAN, uma solução completa que vai além do firewall e SDWAN. Tenha segurança avançada, manipulação de tráfego e priorização de aplicações críticas.">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-wan.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-wan.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-wan.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/logo-wan.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/logo-wan.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-wan.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/logo-wan.png">
    ...
    <div class="main-wrapper">
        ...
        <!--header start-->
        <header class="main-header position-absolute w-100" id="defPage" page="wan/">
        ...
        <!-- Hero Start  -->
        <section class="hero-section text-white hero-ten background-xwan">
            <div class="container">
                <div class="row align-items-center main-content">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <h1 class="fw-bold display-5 text-white">
                                <img src="../assets/img/logo-wan.png" alt="Logo-XWAN" class="img-fuid mb-3" style="height: 30px">
                            </h1>
                            <p class="lead ">
        ...
        <section class="container">
            <div class="mb-5 p-5" id="sobre">
                <h1 class="text-center mt-5 mb-5 text-primary p-5">WAN</h1>
                <ul class="row align-items-center col-12 justify-content-center">
                    <li class="row col-12 border-bottom mb-5">
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-activity col-12 mb-3" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2Z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center ">SD-WAN completo + Pacote completo do firewall.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Solução completa + manipulação de trafego e priorização por gravidade.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-shield-fill col-12 mb-3" viewBox="0 0 16 16">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Segurança inclusa no pacote (local sem precisar ir pra um ponto central).</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-gear-wide col-12 mb-3" viewBox="0 0 16 16">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Gerenciamento centralizado + Application Control + AIOPs.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0  text-center">Nativo no Firewall e nativo do FORTIOS</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-node-plus-fill col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M11 13a5 5 0 1 0-4.975-5.5H4A1.5 1.5 0 0 0 2.5 6h-1A1.5 1.5 0 0 0 0 7.5v1A1.5 1.5 0 0 0 1.5 10h1A1.5 1.5 0 0 0 4 8.5h2.025A5 5 0 0 0 11 13zm.5-7.5v2h2a.5.5 0 0 1 0 1h-2v2a.5.5 0 0 1-1 0v-2h-2a.5.5 0 0 1 0-1h2v-2a.5.5 0 0 1 1 0z"/>
                            </svg>
                            <p class="col-12 p-0 mb-0 text-center">Proteção e WEB FILTERING nas pontas + Telemetria.</p>
                        </a>
