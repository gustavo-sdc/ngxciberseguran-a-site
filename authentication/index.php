...
<!-- Tags SEO -->
    ...
    <link rel="canonical" href="https://qd7.com.br/authentication">
    <meta property="og:url" content="https://qd7.com.br/authentication">
    
    <!-- Title -->
    <title>Authentication: Plataforma de Autenticação com Segurança Fim a Fim - QD7</title>
    <meta property="og:title" content="Authentication: Plataforma de Autenticação com Segurança Fim a Fim - QD7">
    <meta name="twitter:title" content="Authentication: Plataforma de Autenticação com Segurança Fim a Fim - QD7">
    
    <!-- Description -->
    <meta name="description" content="Obtenha a plataforma completa de autenticação, que oferece segurança abrangente em todas as etapas. Proteja seus dados e garanta autenticação confiável. Saiba mais agora!">
    <meta property="og:description" content="Obtenha a plataforma completa de autenticação, que oferece segurança abrangente em todas as etapas. Proteja seus dados e garanta autenticação confiável. Saiba mais agora!">
    <meta property="og:description" content="Obtenha a plataforma completa de autenticação, que oferece segurança abrangente em todas as etapas. Proteja seus dados e garanta autenticação confiável. Saiba mais agora!">
    <meta name="twitter:description" content="Obtenha a plataforma completa de autenticação, que oferece segurança abrangente em todas as etapas. Proteja seus dados e garanta autenticação confiável. Saiba mais agora!">
                ...
                <div class="row align-items-center main-content">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <img src="../assets/img/logo-authentication.png" alt="logo-xauthentication" class="img-fuid mb-3" style="height: 30px">
                            <p class="lead ">
                                Plataforma completa de autenticação, com seguranca contemplada fim a fim.  
                            </p>
                ...
                <ul class="row align-items-center col-12 justify-content-center">
                    <li class="row col-12 border-bottom mb-5">
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center ">Plataforma completa de autenticação + Authenticator com modelos de redundancia (VM ou Appliance).</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Autentição de VPN - SSL VPN (cliente fortinet - windows / mac / linux).</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0  text-center">MFA com token da própria fortinet + MFA no logon do Windows.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0  text-center">Integração com AD da MICROSOFT, com regras de sincronização automática para grupos de usuários.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Alocação de tokens de forma automática para grupos de AD configurados.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">PEAP, TTLS, TLS, certificado digital por usuário, autenticação 802.1x, LDAP-S, LDAP, Join no grupo do AD.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Integração com RADIUS, MIST JUNIPER + Integração com SINGLE SIGN ON + Bases externas de LDAP, etc.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Se usuário tiver bloqueado no AD ou com senha expirada, permite realizar o reset remoto de senha.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Rastreamento de login dos usuários + Bloqueio por período de atividade.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Administração Grafica que facilita o troubleshooting</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Concentração de token (centralização de MFA no forti authenticator).</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Autenticação de equipamentos de rede, centralizados no authenticator.</p>
                        </a>
                    </li>
