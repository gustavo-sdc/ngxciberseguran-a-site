...
<head>
    ...
    <link rel="canonical" href="https://qd7.com.br/check">
    <meta property="og:url" content="https://qd7.com.br/check">
    
    <!-- Title -->
    <title>Check: Regras de Chacagem Inteligentes para Maior Segurança - QD7</title>
    <meta property="og:title" content="Check: Regras de Chacagem Inteligentes para Maior Segurança - QD7">
    <meta name="twitter:title" content="Check: Regras de Chacagem Inteligentes para Maior Segurança - QD7">
    
    <!-- Description -->
    <meta name="description" content="Descubra o Check e vá além do NAC tradicional. Com regras de chacagem inteligentes e posturas de perfis de acesso, nossa solução oferece maior segurança e rastreabilidade para sua empresa.">
    <meta property="og:description" content="Descubra o Check e vá além do NAC tradicional. Com regras de chacagem inteligentes e posturas de perfis de acesso, nossa solução oferece maior segurança e rastreabilidade para sua empresa.">
    <meta property="og:description" content="Descubra o Check e vá além do NAC tradicional. Com regras de chacagem inteligentes e posturas de perfis de acesso, nossa solução oferece maior segurança e rastreabilidade para sua empresa.">
    <meta name="twitter:description" content="Descubra o Check e vá além do NAC tradicional. Com regras de chacagem inteligentes e posturas de perfis de acesso, nossa solução oferece maior segurança e rastreabilidade para sua empresa.">
    
    <!-- Link da imagem do banner do produto -->
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-check.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-check.png">
    <meta name="twitter:image" content="https://qd7.com.br/assets/img/logo-check.png">
    <meta property="og:url" content="https://qd7.com.br/assets/img/logo-check.png">
    <meta name="thumbnail" content="https://qd7.com.br/assets/img/logo-check.png">
    <meta property="og:image" content="https://qd7.com.br/assets/img/logo-check.png">
    <meta property="og:image:secure_url" content="https://qd7.com.br/assets/img/logo-check.png">
...
<body>
     ...
     <div class="main-wrapper">
        ...
        <!--header start-->
        <header class="main-header position-absolute w-100" id="defPage" page="check/">
        ...
        <!-- Hero Start  -->
        <section class="hero-section text-white hero-ten background-xcheck" >
            <div class="container">
                <div class="row align-items-center main-content">
                    <div class="col-lg-6 col-md-10">
                        <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                            <img src="../assets/img/logo-check.png" alt="Logo-check" class="img-fuid mb-3" style="height: 30px">
                            <p class="lead ">
                                Muito além do NAC, regras de chacagem inteligentes, com posturas de perfis de acesso, gerando mais segurança e rastreabilidade. 
                            </p>
        ...
        <section class="container">
            <div class="mb-5 p-5" id="sobre">
                <h1 class="text-center mt-5 mb-5 text-primary p-5">Check</h1>
                <ul class="row align-items-center col-12 justify-content-center">
                    <li class="row col-12 border-bottom mb-5">
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center ">NAC da Fortnet + VM FORTINET + DHCP / SNMP</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-card-list col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                                <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
                              </svg>
                            <p class="col-12 p-0 mb-0 text-center">Integracao com AD, Radius, LDAP + IoT + Profiing + Multivendor + Certificado</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Postura | Politicas para perfils de dispositivos na rede.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0  text-center">Portas de rede seja conhecidas ou desconhecidas solicitam admissão.</p>
                        </a>
                        ...
                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            ...
                            <p class="col-12 p-0 mb-0 text-center">Identificador de dispositivo + Autenticação + Autenticacao de redes sem fio PEAP, EAP, etc.</p>
                        </a>

                        <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="44" fill="currentColor" class="bi bi-cash col-12 mb-3" viewBox="0 0 16 16">
                                <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                                <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V4zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2H3z"/>
                              </svg>
                            <p class="col-12 p-0 mb-0 text-center">Custo por dispositivo concorrente ligado</p>
                        </a>
                    </li>

                    <a class="btn text-primary bg-body me-xl-3 col-12 col-md-4" href="#contact">Contratar ></a>
                </ul>
