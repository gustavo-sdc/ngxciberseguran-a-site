...
const iconNutanix = document.querySelectorAll('#iconNutanix')
const iconAkamai = document.querySelectorAll('#iconAkamai')
const iconArista = documetn.querySelectorAll('#iconArista')
const iconPaloAlto = document.querySelectorAll('#iconPaloAlto')
...
const nutanix = document.querySelectorAll('#nutanix')
const paloAlto = document.querySelectorAll('#palo-alto')
const akamai = document.querySelectorAll('#akamai')
const arista = document.querySelectorAll('#arista')
...
const linkBase = 'https://qd7.com.br'
...
const links = {
    ...
    iconNutanix: linkBase+'assets/img/nutanix/favicon-nutanix.png',
    iconArista: linkBase+'assets/img/nutanix/favicon-arista.png',
    iconAkamai: linkBase+'assets/img/nutanix/favicon-akamai.png',
    iconPaloAlto: linkBase+'assets/img/nutanix/icon-paloalto.png',
    ...
    nutanix: 'https://lp.qd7.com.br/nutanix',
    arista: 'https://lp.qd7.com.br/arista',
    akamai: 'https://lp.qd7.com.br/akamai',
    paloAlto: 'https://lp.qd7.com.br/palo-alto',
...
nutanix.forEach((e)=>e.setAttribute('href', `${links.nutanix}`))
arista.forEach((e)=> e.setAttribute('href', `${links.arista}`))
akamai.forEach((e)=>e.setAttribute('href', `${links.akamai}`))
paloAlto.forEach((e)=>e.setAttribute('href', `${links.paloAlto}`))
