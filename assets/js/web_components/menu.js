class qd7menu extends HTMLElement{
  constructor(){
    super()
    ...
    const foot = this.elements(this.page)
  ...
  elements(page){
      ...
      html.setAttribute('class', 'main-header position-absolute w-100')
      const translate = `https://qd7.com.br/en/${page}`;

      html.innerHTML=`
        <script defer scr="https://qd7.com.br/assets/js/vendors/jquery-3.6.0.min.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/vendors/bootstrap.bundle.min.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/vendors/swiper-bundle.min.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/vendors/jquery.magnific-popup.min.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/vendors/parallax.min.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/vendors/aos.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/vendors/massonry.min.js"></script>
        <script defer scr="https://qd7.com.br/assets/js/app.js"></script>

        <nav class="navbar navbar-expand-xl navbar-dark sticky-header z-10">

        <div class="container d-flex align-items-center justify-content-lg-between position-relative">
            <a href="" class="navbar-brand d-flex align-items-center mb-md-0 text-decoration-none col-3">
                <img src="https://qd7.com.br/assets/img/logo-qd7.png" alt="logo" class="img-fluid logo-white col-10 col-lg-3" />
                <img src="https://qd7.com.br/assets/img/logo-qd7.png" alt="logo" class="img-fluid logo-color col-10 col-lg-3" />
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-center">
                ...
                <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                    ...
                    <li><a href="https://qd7.com.br/" class="nav-link">Home</a></li>

                    <li class="nav-item dropdown">

                        <a class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="dropdownButton">Soluções</a>



                        <div class="dropdown-menu border-0 rounded-custom shadow py-0 bg-white width-fullhomepage-list-wrapper hide" id="dropdownBox">

                            <div class="dropdown-grid rounded-custom homepage-dropdown">
                                
                                <div class="dropdown-grid-item bg-white radius-left-side">
                                    <a href="https://qd7.com.br/deep-inspection/" class="dropdown-link col-lg-12">
                                        <span class="demo-list icon-services rounded text-white fw-bold">
                                            <img src="https://qd7.com.br/assets/img/icons/AiOutlineSchedule.png" alt="icon-schedule" class="icon-services">
                                        </span>
                                        <div class="dropdown-info">
                                            <div class="drop-title">Deep Inspection</div>
                                        </div>
                                    </a>
                                    <a href="https://qd7.com.br/authentication/" class="dropdown-link">
                                        <span class="demo-list rounded text-white fw-bold">
                                            <img src="https://qd7.com.br/assets/img/icons/AiOutlineUnlock.png" alt="icon-auth" class="icon-services">
                                        </span>
                                        <div class="dropdown-info">
                                    ...
                                    <a href="https://qd7.com.br/check/" class="dropdown-link col-lg-12">
                                        <span class="demo-list  rounded text-white fw-bold">
                                            <img src="https://qd7.com.br/assets/img/icons/CgSearchFound.png" alt="icon-search" class="icon-services">
                                        </span>
                                        <div class="dropdown-info">
                                    ...
                                    <a href="https://qd7.com.br/wan/" class="dropdown-link col-lg-12">
                                        <span class="demo-list  rounded text-white fw-bold">
                                            <img src="https://qd7.com.br/assets/img/icons/CgMediaPodcast.png" alt="icon-Network" class="icon-services">
                                        </span>
                                        <div class="dropdown-info">
                                            <div class="drop-title">WAN</div>
                                        </div>
                                    </a>
                                    <a href="https://qd7.com.br/analyser-360/" class="dropdown-link col-lg-12">
                                        <span class="demo-list rounded text-white fw-bold">                                                    
                                            <img src="https://qd7.com.br/assets/img/icons/CgEye.png" alt="icon-eye" class="icon-services">
                                        </span>
                                        <div class="dropdown-info">
                                    ...
                                    <a href="https://qd7.com.br/sase+/" class="dropdown-link col-lg-12">
                                        <span class="demo-list  rounded text-white fw-bold">
                                            <img src="https://qd7.com.br/assets/img/icons/CgListTree.png" alt="icon-proxy" class="icon-services">
                                        </span>
                                        <div class="dropdown-info">
                    ...
                    <li><a href="https://qd7.com.br/#sobre" class="nav-link">Sobre</a></li>
                    <li><a href="https://qd7.com.br/#contato" class="nav-link">Contato</a></li>
                    <li><a href="https://blog.qd7.com.br/" class="nav-link">News</a></li>
            ...
            <div class="action-btns text-end me-5 me-lg-0 d-none d-md-block d-lg-block content-buttons-menu">
                ...
                <a href='${translate}' class="btn-translate btn btn-link" style=" margin:0% 0% 0% 0% !important; padding:0% !important;">EN</a>
            
                <a href="https://api.whatsapp.com/send/?phone=5517981125394&text=Ol%C3%A1%2C+%0D%0AGostaria+de+saber+mais+sobre+as+solu%C3%A7%C3%B5es+da+QD7&type=phone_number&app_absent=0" class="btn btn-link" style=" margin:0% 0% 2% 0% !important; padding:0% !important;"><i class="fab fa-whatsapp" data-bs-placement="bottom" data-bs-toggle="tooltip" data-bs-title="WhatsApp" style="font-size: 1.25rem;"></i></a>
                <a href="https://www.instagram.com/qd7.cybersecurity" class="btn btn-link" style=" margin:0% 0% 2% 0% !important; padding:0% !important;"><i class="fab fa-instagram" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Instagram" style="font-size: 1.25rem;"></i></a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
        <div class="offcanvas-header d-flex align-items-center mt-4">
            <a href="" class="d-flex align-items-center mb-md-0 text-decoration-none">
                <img src="assets/img/logo-qd7.png" alt="logo" class="img-fluid logo-color col-4 col-lg-3" />
            </a>
        ...
        <div class="offcanvas-body z-10">
            <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                    ...
                    <div class="dropdown-menu border-0 rounded-custom shadow py-0 bg-white homepage-list-wrapper">
                        <div class="dropdown-grid rounded-custom width-full homepage-dropdown">
                            <div class="dropdown-grid-item">
                                <a href="https://qd7.com.br/check/" class="dropdown-link col-12">
                                    <div class="dropdown-info">
                                        <div class="drop-title">Check</div>
                                    </div>
                                </a>
                                <a href="https://qd7.com.br/deep-inspection/" class="dropdown-link col-12">
                                    <div class="dropdown-info">
                                        <div class="drop-title">Deep Inspection</div>
                                        </p>
                                    </div>
                                </a>
                                <a href="https://qd7.com.br/analyser-360/" class="dropdown-link col-12">
                                    <div class="dropdown-info">
                                        <div class="drop-title">Analyser-360</div>

                                    </div>
                                </a>
                                <a href="https://qd7.com.br/sase+/" class="dropdown-link col-12">
                                    <div class="dropdown-info">
                                        <div class="drop-title">Sase+</div>
                                    </div>
                                </a>
                                <a href="https://qd7.com.br/authentication/" class="dropdown-link col-12">
                                    <div class="dropdown-info">
                                        <div class="drop-title">Authentication</div>
                                        </p>
                                    </div>
                                </a>
                                <a href="https://qd7.com.br/wan/" class="dropdown-link col-12">
                                    <div class="dropdown-info">
                                        <div class="drop-title">WAN</div>
                                    </div>
                                </a>
                ...
                <li><a href="https://qd7.com.br/#contato" class="nav-link">Contato</a></li>
                <li><a href="https://blog.qd7.com.br/" class="nav-link">News</a></li>
                <div class="action-btns text-end me-5 me-lg-0 d-md-block d-lg-block content-buttons-menu">
                    <a href="javascript:void(0)" class="btn btn-link p-1 tt-theme-toggle">
                        <div class="tt-theme-light" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Light"><i class="flaticon-sun-1 fs-lg"></i></div>
                        <div class="tt-theme-dark" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Dark"><i class="flaticon-moon-1 fs-lg"></i></div>
                    </a> 
                    
                    <a href="${translate}" class="btn-translate btn btn-link" style=" margin:0% 0% 0% 0% !important; padding:0% !important; color:grey;">EN</a>
                
                    <a href="https://api.whatsapp.com/send?phone=5517981125394&text=Time%20NGX%20agradece%20o%20seu%20contato,%20em%20breve%20retornaremos%20sua%20mensagem" class="btn btn-link" style=" margin:0% 0% 2% 0% !important; padding:0% !important;"><i class="fab fa-whatsapp" data-bs-placement="bottom" data-bs-toggle="tooltip" data-bs-title="WhatsApp" style="font-size: 1.25rem;"></i></a>
                    <a href="https://www.instagram.com/qd7.cybersecurity" class="btn btn-link" style=" margin:0% 0% 2% 0% !important; padding:0% !important;"><i class="fab fa-instagram" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Instagram" style="font-size: 1.25rem;"></i></a>
  ...
  style(){
    ...
    */
    ...
    --bs-primary-border-subtle: #fecc9e;
    --bs-secondary-border-subtle: #e5e5e5;
    --bs-success-border-subtle: #cecfa3;
    --bs-info-border-subtle: #f9de9e;
    ...
    --bs-border-color: rgba(39, 31, 17, 0.12);
    ...
    *::after {
    ...
    border-color: #ff6900;
    outline: 0;
    -webkit-box-shadow: 0 0 0 0 rgba(255, 105, 0, .25);
    box-shadow: 0 0 0 0 rgba(255, 105, 0, .25)
    }
    ...
    outline: 0;
    -webkit-box-shadow: 0 0 0 0 rgba(255, 105, 0, .25);
    box-shadow: 0 0 0 0 rgba(255, 105, 05, .25)
    }
    ...
    -webkit-box-shadow: 0 0 0 1px #fff, 0 0 0 0 rgba(255, 105, 0, .25);
    box-shadow: 0 0 0 1px #fff, 0 0 0 0 rgba(255, 105, 0, .25)
    }
    ...
    --bs-btn-color: #0c0800;
    --bs-btn-bg: #ff8934;
    --bs-btn-border-color: #ff8934;
    --bs-btn-hover-color: #0c0800;
    --bs-btn-hover-bg: #ff8934;
    --bs-btn-hover-border-color: #ff8934;
    --bs-btn-focus-shadow-rgb: 15, 177, 217;
    --bs-btn-active-color: #0c0800;
    --bs-btn-active-bg: #ff8934;
    --bs-btn-active-border-color: #ff8934;
    --bs-btn-active-shadow: unset;
    --bs-btn-disabled-color: #0c0800;
    --bs-btn-disabled-bg: #ff8934;
    ...
    .btn-outline-info {
    --bs-btn-color: #ffa30f;
    --bs-btn-border-color: #ffa70f;
    --bs-btn-hover-color: #0c0800;
    --bs-btn-hover-bg: #ffcb0f;
    --bs-btn-hover-border-color: #ffb70f;
    --bs-btn-focus-shadow-rgb: 255, 105, 0;
    --bs-btn-active-color: #0c0800;
    --bs-btn-active-bg: #ffbb0f;
    --bs-btn-active-border-color: #ffa70f;
    --bs-btn-active-shadow: unset;
    --bs-btn-disabled-color: #ffab0f;
    --bs-btn-disabled-bg: transparent;
    --bs-btn-disabled-border-color: #ff730f;
    --bs-gradient: none
    }
    ...
    --bs-dropdown-link-active-bg: #ff6900;
    ...
    --bs-nav-pills-link-active-bg: #ff6900
    }
    ...
    --bs-accordion-btn-focus-border-color: #ff6900;
    ...
    --bs-pagination-focus-box-shadow: 0 0 0 0 rgba(255, 105, 0, 0.25);
    --bs-pagination-active-color: #ffffff;
    --bs-pagination-active-bg: #ff6900;
    --bs-pagination-active-border-color: #ff6900;
    ...
    --bs-list-group-active-bg: #ff6900;
    --bs-list-group-active-border-color: #ff6900;
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    -webkit-box-orient: vertical;
    ...
    --bs-btn-close-focus-shadow: 0 0 0 0 rgba(255, 105, 0, 0.25);
    ...
    .text-bg-primary {
    color: #fff !important;
    background-color: RGBA(255, 105, 0, var(--bs-bg-opacity, 1)) !important
    }
    ...
    *::after {
    ...
    .display-404 {
    color: #fff;
    text-shadow: -0.0625rem 0 ff6900, 0 .0625rem ff6900, .0625rem 0 ff6900, 0 -0.0625rem ff6900
    }
    ...
    .bg-primary-light {
    background-color: rgba(255, 105, 0, .75)
    }
    ...
    .primary-bg-gradient {
    background: -webkit-gradient(linear, left top, right top, from(#111827), to(ff6900)) !important;
    background: linear-gradient(90deg, #111827, ff6900) !important
    }

    .info-bg-gradient {
    background: -webkit-gradient(linear, left top, right top, from(ff6900), to(#0FCFFF)) !important;
    background: linear-gradient(90deg, ff6900, #0FCFFF) !important
    }
    ...
    .dark-bg-gradient {
    background: -webkit-gradient(linear, left top, right top, from(ff6900), to(#111827)) !important;
    background: linear-gradient(90deg, ff6900, #111827) !important
    }
    ...
    .bg-gradient {
    background: -webkit-gradient(linear, left top, right top, from(#000717), to(#ff6900)) !important;
    background: linear-gradient(90deg, #000717, #ff6900) !important
    }

    a,
    .btn-link {
    color: rgba(255, 105, 0, .85);
    -webkit-transition: all .3s ease-in-out;
    transition: all .3s ease-in-out
    }
    ...
    .two-bg-color {
    background-image: -webkit-gradient(linear, left top, right top, color-stop(40%, ff6900), color-stop(0, var(--bs-light)));
    background-image: linear-gradient(90deg, ff6900 40%, var(--bs-light) 0)
    }
    ...
    -webkit-box-shadow: 0 .5rem 1.125rem -0.5rem rgba(255, 105, 0, .9);
    box-shadow: 0 .5rem 1.125rem -0.5rem rgba(255, 105, 0, .9)
    }
    ...
    border-color: rgba(255, 105, 0, .15)
    }
    ...
    .google-btn:hover,
    .facebook-btn:hover {
    background: rgba(255, 105, 0, .25) !important
    }
    ...
    .bg-primary-alt {
    background-color: rgba(255, 105, 0, .12)
    }
    ...
    .ins-contact-form .ins-input-field input::-webkit-input-placeholder,
    .ins-contact-form .ins-input-field select::-webkit-input-placeholder {
    color: #e4e4e4
    }

    .ins-contact-form .ins-input-field input::-moz-placeholder,
    .ins-contact-form .ins-input-field select::-moz-placeholder {
    color: #e4e4e4
    }

    .ins-contact-form .ins-input-field input:-ms-input-placeholder,
    .ins-contact-form .ins-input-field select:-ms-input-placeholder {
    color: #e4e4e4
    }
    ...
    background: -webkit-gradient(linear, left top, right top, from(#171717), to(#ff6900)) !important;
    background: linear-gradient(90deg, #171717, #ff6900) !important
    }
...
customElements.define('qd7-menu', qd7menu)