...
<head>
    ...
    <link rel="canonical" href="https://qd7.com.br/analyser-360">
    <meta property="og:url" content="https://qd7.com.br/analyser-360">
    
    <!-- Title -->
    <title>Analyser 360: Análise e Monitoramento de Ameaças em Tempo Real - QD7</title>
    <meta property="og:title" content="Analyser 360: Análise e Monitoramento de Ameaças em Tempo Real - QD7">
    <meta name="twitter:title" content="Analyser 360: Análise e Monitoramento de Ameaças em Tempo Real - QD7">
    
    <!-- Description -->
    <meta name="description" content="Detecção avançada e correlação de comportamento de assinaturas e LOGs. Proteja sua empresa contra ameaças cibernéticas. Saiba mais!">
    <meta property="og:description" content="Detecção avançada e correlação de comportamento de assinaturas e LOGs. Proteja sua empresa contra ameaças cibernéticas. Saiba mais!">
    <meta property="og:description" content="Detecção avançada e correlação de comportamento de assinaturas e LOGs. Proteja sua empresa contra ameaças cibernéticas. Saiba mais!">
    <meta name="twitter:description" content="Detecção avançada e correlação de comportamento de assinaturas e LOGs. Proteja sua empresa contra ameaças cibernéticas. Saiba mais!">
...
<body>
        ...
        <!--header end-->
            ...
            <!-- Hero Start  -->
            <section class="hero-section text-white hero-ten background-xnalyser">
                <div class="container">
                    <div class="row align-items-center main-content">
                        <div class="col-lg-6 col-md-10">
                            <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                                <img src="../assets/img/logo-analyser.png" alt="logo-xnlyser" class="img-fuid mb-3" style="height: 30px">
                                <p class="lead ">
                    ...
                    <ul class="row align-items-center col-12 justify-content-center">
                        <li class="row col-12 border-bottom mb-5">
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center ">Integracao Nativa com o Fortigate + Analyser + SD-WAN e IPSEC em escala no High End.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Central de log's dos Firewalls com possibilidade de correlacao de LOG</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0  text-center">Integrado com SOC - Mostra eventos que considera problemáticos baseado no nível ameáças.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0  text-center">Baseado em análise de comportamento e assinaturas, mostra possíveis dispositivos infectados com ransware.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Uma tela para log's com maiores riscos + possibilidade de tela SOC da empresa.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Command and control - deteção e visualização em tempo real + solução em HA via VM.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Relatorios padrão +300 customizados com select no banco SQL.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Arquitetura distribuida em hardware com ASIC + Caixas com suporte a ASIC.</p>
                            </a>
                            ...
                            <a class="col-12 col-xl-4 align-items-center justify-content-center text-dark-emphasis mb-5">
                                ...
                                <p class="col-12 p-0 mb-0 text-center">Projeto de chassis 7121 Ultra High End - Chassis Modular.</p>
                            </a>
                        </li>
